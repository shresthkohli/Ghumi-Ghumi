    ...
    return (
        <main ref={containerRef} className="min-h-screen bg-background pt-[100px] pb-24 overflow-hidden relative">
            ...
            <div className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop relative z-10">
                ...
                <section className="text-center max-w-3xl mx-auto py-12 md:py-16 flex flex-col items-center">
                    <div
                        data-animate-hero
                        className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-primary-fixed/50 border border-primary/20 shadow-xs mb-6"
                    >
                    ...
                    <h1
                        data-animate-hero
                        className="font-display text-display-md md:text-display-lg text-on-surface leading-tight font-bold mb-6"
                    >
                        Our Travel Journal is Taking Flight
                    </h1>
                    <p
                        data-animate-hero
                        className="font-body text-base md:text-lg text-on-surface-variant/80 leading-relaxed max-w-2xl mb-8"
                    >
                    ...
                    <div data-animate-hero className="flex flex-wrap items-center justify-center gap-4">
                        <Link
                            to="/destinations"
                            className="px-7 py-3 rounded-full bg-primary text-on-primary font-body text-sm font-semibold shadow-[0_12px_28px_rgba(162,63,26,0.25)] hover:scale-105 active:scale-98 transition-all duration-300 flex items-center gap-2"
                        >
                        ...
                        <Link
                            to="/itineraries"
                            className="px-7 py-3 rounded-full border border-outline-variant bg-surface font-body text-sm font-semibold text-on-surface hover:bg-surface-container transition-all duration-200 flex items-center gap-2 shadow-2xs hover:scale-102"
                        >
                ...
                <section className="mt-8 md:mt-12">
                    <div className="flex flex-col items-center mb-8 text-center">
                        <span className="font-label-md text-xs font-bold uppercase tracking-widest text-primary mb-1">
                            Sneak Peek
                        </span>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-gutter">
                        {UPCOMING_STORIES.map((story) => (
                            <article
                                ...
                                className="rounded-3xl p-7 border shadow-sm relative overflow-hidden flex flex-col justify-between group hover:shadow-md hover:-translate-y-1 transition-all duration-300"
                            >
                                <div>
