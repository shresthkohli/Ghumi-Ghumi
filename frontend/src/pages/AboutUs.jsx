...
import { Compass, Heart, Shield, Award, Users, ArrowRight } from "lucide-react";
...
function AboutUs() {
  ...
  return (
    <div className="min-h-screen bg-background text-on-surface pt-[90px]">
      ...
      {/* Stats Bar */}
      <section className="border-y border-outline-variant/30 bg-surface-container py-12 px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {values.map((val) => {
            ...
            return (
              <div
                key={val.title}
                className="glass-widget rounded-2xl p-8 border border-outline-variant/20 transition-all duration-300 hover:-translate-y-1.5 hover:shadow-lg"
              >
      ...
      <section className="px-6 py-16 md:px-margin-desktop">
        <div className="mx-auto max-w-5xl rounded-3xl bg-surface-container-high border border-outline-variant/30 p-10 md:p-16 text-center relative overflow-hidden">
